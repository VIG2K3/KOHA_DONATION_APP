        ...
        switch (name) {
            case "KFC (100 KO-Points)":
                description = "<b>CRAVING SOMETHING DELICIOUS?</b><br><br>" +
                        ...
                        "Perfect for lunch, dinner, or a quick snack — all for just 100 KO-Points! Note: Voucher will expire in 30 days after redemption";
            ...
            case "TNG (500 KO-Points)":
                description = "<b>STAY CASHLESS AND CONVENIENT!</b><br><br>" +
                        ...
                        "Perfect for tolls, parking, and everyday purchases — only 500 KO-Points needed! Note: Voucher will expire in 30 days after redemption";
            ...
            case "XOX (200 KO-Points)":
                description = "<b>RUNNING LOW ON MOBILE CREDIT?</b><br><br>" +
                        ...
                        "Get RM5 credit instantly for just 200 KO-Points! Note: Voucher will expire in 30 days after redemption";
            ...
            case "GRAB (300 KO-Points)":
                description = "<b>GO ANYWHERE, EAT ANYTHING!</b><br><br>" +
                        ...
                        "Travel smarter and dine easier — all for 300 KO-Points! Note: Voucher will expire in 30 days after redemption";
            ...
            case "DIY (400 KO-Points)":
                description = "<b>TIME TO GET CREATIVE!</b><br><br>" +
                        ...
                        "Upgrade your home or find something handy — all with 400 KO-Points! Note: Voucher will expire in 30 days after redemption";
            ...
            case "LOTUS (400 KO-Points)":
                description = "<b>SHOP MORE, SAVE MORE!</b><br><br>" +
                        ...
                        "Turn your points into savings — only 400 KO-Points! Note: Voucher will expire in 30 days after redemption";
                redeemButton.setText("Redeem for 400 KO-Points");
                break;
        }
            ...
            new androidx.appcompat.app.AlertDialog.Builder(RewardDash.this)
                    ...
                    .setPositiveButton("Yes", (dialog, which) -> {
                        new androidx.appcompat.app.AlertDialog.Builder(RewardDash.this)
                                ...
                                .setMessage("You have successfully redeemed " + name + "Valid for only 30 days!")
